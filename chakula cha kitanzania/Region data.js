const allRegions = [
  ...
  { name: "Katavi", image: "images/katavi.jpg" },
  { name: "Kigoma", image: "images/kigoma.jpg" },
  { name: "Kilimanjaro", image: "images/kilimanjaro.jpg" },
  { name: "Lindi", image: "images/lindi.jpg" },

  { name: "Manyara", image: "images/manyara.jpg" },
  { name: "Mara", image: "images/mara.jpg" },
  { name: "Mbeya", image: "images/mbeya.jpg" },
  { name: "Morogoro", image: "images/morogoro.jpg" },
  { name: "Mtwara", image: "images/mtwara.jpg" },

  { name: "Mwanza", image: "images/mwanza.jpg" },
  { name: "Njombe", image: "images/njombe.jpg" },
  { name: "Pemba Kusini (Zanzibar)", image: "images/pemba_kusini.jpg" },
  { name: "Pemba Kaskazini (Zanzibar)", image: "images/pemba_kaskazini.jpg" },
  { name: "Pwani", image: "images/pwani.jpg" },

  { name: "Rukwa (Sumbawanga)", image: "images/rukwa.jpg" },
  { name: "Ruvuma (Songea)", image: "images/ruvuma.jpg" },
  { name: "Shinyanga", image: "images/shinyanga.jpg" },
  { name: "Simiyu (Bariadi)", image: "images/simiyu.jpg" },
  { name: "Singida", image: "images/singida.jpg" },

  { name: "Songwe", image: "images/songwe.jpg" },
  { name: "Tabora", image: "images/tabora.jpg" },
  { name: "Tanga", image: "images/tanga.jpg" },
  { name: "Unguja Kusini (Zanzibar)", image: "images/unguja_kusini.jpg" },
  { name: "Unguja Kaskazini (Zanzibar)", image: "images/unguja_kaskazini.jpg" },

  { name: "Unguja Mjini Magharibi", image: "images/unguja_mjini_magharibi.jpg" }
];
// =======================
// TRIBES DATA
// =======================
...
{
region:"Arusha",
name:"Waarusha, Wameru, Wamaasai, Wambulu,",
image:"https://tse1.mm.bing.net/th/id/OIP.Gp4dcFAwKhgrIxaNqHi7AAHaEq?r=0&cb=thfc1falcon&rs=1&pid=ImgDetMain&o=7&rm=3",
foods:[
...
name:"Wazaramo, Waswahili, pamoja na makabila yote ya Tanzania kwa kuwa mji mkuu wa biashara)",
...
{
region:"Dodoma",
name:"Wagogo, Warangi (kwa sehemu), Wasandawe",
...
{
region:"Geita",
name:"Wasukuma, Wahaya, Wazinza, Wakerewe",
...
{
region:"Kagera",
name:"Wahaya, Wazinza, Wahangaza, Wasubi",
image:"https://picsum.photos/600/400?1",
foods:[
...
{
region:"Katavi",
name:"Wabende, wasukuma, Wapimbwe, wafipa(kwa karibu)",
image:"https://picsum.photos/600/400?1",
foods:[
...
{
region:"Kigoma",
name:"Waha, wahangaza, Wavinza, Wabembe, Watongwe",
image:"https://picsum.photos/600/400?1",
foods:[
...
{
region:"Lindi",
name:"Wamachinga, Wamakonde, Wangindo,  Watumbi",
image:"https://picsum.photos/600/400?1",
foods:[
...
{
region:"Manyara",
name:"Wairaqw,Wamaasai, Warangi, Wambugwe, Wagorowa",
image:"https://picsum.photos/600/400?1",
foods:[
...
{
region:"Mara",
name:"Wakurya, Wakwaya, Wazanaki, Wakerewe, Wajita",
image:"https://picsum.photos/600/400?1",
foods:[
...
{
region:"Mbeya",
name:"Wanyakyusa, Wandali, Wafafwa, Wabungu, Wakinga",
image:"https://picsum.photos/600/400?1",
foods:[
...
{
region:"Morogoro",
name:"Waluguru, Wazaramo, Wakaguru, Wanguru, Wapogoro",
image:"https://picsum.photos/600/400?1",
foods:[
...
{
region:"Mtwara",
name:"Wamakonde, Wamachinga, Wangindo, Wamatumbi",
image:"https://picsum.photos/600/400?1",
foods:[
...
{
region:"Mwanza",
name:"Wasukuma (wengi), Wakerewe, Wazinza, Wakara",
image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQh1mnq85ajY4CBAYF3o1533gSjGEPYdJH1Wg&s",
foods:[
...
{
region:"Njombe",
name:"Wabena, Wakinga, Wanyakyusa(kwa sehemu)",
...
{
region:"Mkoa wa pemba kaskazini(Zanzibar)",
name:"Wapemba(Waswahili), Waarabu",
...
{
region:"Pwani(kibaha)",
name:"Wazaramo, Wakwete, Warufiji, Wangindo",
...
name:"Wafipa, Wambwela, Wamambwe, Wapimbwe",
...
name:"Wamakonde, Wangoni, Wamachinga, Wamatumbi",
...
{
region:"Shinyanga",
name:"Wasukuma, Wanyamwezi,(sehemu), Wazinza",
...
name:"Wasukuma, Wanyamwezi, Wazinza",
...
{
region:"Singida",
name:"Wanyaturu, Warangi, Wairaqw, Wagogo",
...
{
region:"Songwe(Vwawa)",
name:"Wanyakyusa, Wandali, Wasafwa, Wabungu",
...
{
region:"Tabora",
name:"Wanyamwezi, Wasukuma,(sehemu), Wavinza",
...
{
region:"Tanga",
name:"Wasambaa, Wasegeju, Wabondei, Wazaramo, Wazigua",
